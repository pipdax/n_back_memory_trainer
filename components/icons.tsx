...
// Modified PlayIcon for better visuals
export const PlayIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 20 20" {...props}>
    <path d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 0111 8.036v3.928a1 1 0 01-1.445.894l-3.222-1.964a1 1 0 010-1.788l3.222-1.964z" />
  </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 16l-4 4-4-4 5.293-5.293a1 1 0 011.414 0L13 13m0 0l-1 1-1-1m2 0l1-1 1 1M5 21v-4m-2 2h4m10-10l2.293-2.293a1 1 0 000-1.414L16 6l-4 4 4 4 1.293-1.293a1 1 0 000-1.414L15 11m0 0l1-1 1 1" />
  </svg>
);

export const CheckIcon: React.FC<React.SVGProps<SVGSVGElement> & { strokeWidth?: number }> = ({ strokeWidth = 3, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M5 13l4 4L19 7" />
  </svg>
);

export const XIcon: React.FC<React.SVGProps<SVGSVGElement> & { strokeWidth?: number }> = ({ strokeWidth = 3, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
